...
export default function QrCode() {
  ...
  return (
    <div className="bg-gray-100 rounded flex flex-col items-center justify-center">
      {response ? (
        <div>
          <img className="w-48 my-2" src={response} alt="QrCode" />
          <button
            onClick={downloadImage}
            className="bg-blue-400 text-white my-2 px-4 py-1 w-full"
          >
            Download
          </button>
        </div>
